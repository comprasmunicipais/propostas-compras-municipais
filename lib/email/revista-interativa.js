...
export function buildCustomerConfirmationMessage(context) {
  ...
  const text = [
    ...
    "",
    "Os dados para pagamento são apresentados após a confirmação do formulário.",
    "",
  ...
  const html = `
    ...
    <p>Os dados para pagamento são apresentados após a confirmação do formulário.</p>
